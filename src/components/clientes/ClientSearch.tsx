  ...
  return (
    <section className="space-y-4">
      <div className="panel-card rounded-2xl p-4">
        <label htmlFor="client-search" className="mb-2 block text-sm font-medium text-zinc-300">
        ...
        <input
          ...
          className="h-12 w-full rounded-xl border border-zinc-700 bg-zinc-950/70 px-4 text-sm text-zinc-100 outline-none transition focus:border-[#8cff59]"
        />
      </div>
