...
export async function GET(
  ...
  const pdfData: PLPDFData = {
    ...
    ingresosPinkyBruto: pl.ingresosPinkyBruto,
    ingresosProductosBruto: pl.ingresosProductosBruto,
    ingresoBrutoTotal: pl.ingresoBrutoTotal,
    comisionGabote: pl.comisionGabote,
    comisionGabotePct: pl.comisionGabotePct,
    costoProductosVendidos: pl.costoProductosVendidos,
    feesMedioPagoTotal: pl.feesMedioPagoTotal,
    margenBruto: pl.margenBruto,
    margenBrutoPct: pl.margenBrutoPct,
    gastosFijosMes: pl.gastosFijosMes,
    gastosPorCategoria: pl.gastosPorCategoria,
    resultadoOperativo: pl.resultadoOperativo,
    cuotaMemasMes: pl.cuotaMemasMes,
    cuotasPagadas: pl.cuotasPagadas,
    cantidadCuotasPactadas: pl.cantidadCuotasPactadas,
    saldoPendiente: pl.saldoPendiente,
    deudaUsd: pl.deudaUsd,
    resultadoNeto: pl.resultadoNeto,
  };
