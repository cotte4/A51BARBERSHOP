...
import { toggleRuletaPrizeActivoAction } from "./actions";
...
export default function ToggleRuletaButton({ id, activo }: Props) {
  const [loading, setLoading] = useState(false);

  async function handleToggle() {
    setLoading(true);
    await toggleRuletaPrizeActivoAction(id, !activo);
    setLoading(false);
  }
