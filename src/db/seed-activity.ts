    ...
    for (let i = 0; i < pinkyCount; i++) {
      ...
      const [at] = await db
        ...
        .values({
          ...
          comisionMedioPagoPct: financials.comisionMedioPagoPct,
          comisionMedioPagoMonto: financials.comisionMedioPagoMonto,
          montoNeto: financials.montoNeto,
          comisionBarberoPct: financials.comisionBarberoPct,
          comisionBarberoMonto: financials.comisionBarberoMonto,
          anulado: false,
          notas: SEED_MARKER,
        })
        .returning();
    ...
    for (let i = 0; i < gaboteCount; i++) {
      ...
      const [at] = await db
        ...
        .values({
          ...
          comisionMedioPagoMonto: financials.comisionMedioPagoMonto,
          montoNeto: financials.montoNeto,
          comisionBarberoPct: makeNullComision ? null : financials.comisionBarberoPct,
          comisionBarberoMonto: makeNullComision ? null : financials.comisionBarberoMonto,
          anulado: false,
          notas: SEED_MARKER,
        })
        .returning();
